...
class AcquirerSystempay(models.Model):
    ...
    def _systempay_compute_multi_warning(self):
    ...
    systempay_multi_warning = fields.Boolean(compute='_systempay_compute_multi_warning')
